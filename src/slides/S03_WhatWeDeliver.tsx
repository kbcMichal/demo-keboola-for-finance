...
const items = [
  ...
  { icon: '\u25C6', color: 'var(--green)', bg: 'var(--green-dim)', title: 'Financial KPIs', desc: 'Core values (Revenue, Expenses, Net Income, Assets, Liabilities, Equity) + ratios (NPM, ROA, ROE, D/E, ER, CIR)' },
